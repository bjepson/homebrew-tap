...
class Mutt < Formula
  ...
  if build.with? "compressed-folders-patch"
    patch do
      url "http://mutt.org.ua/download/mutt-1.5.24/patch-1.5.24.rr.compressed.gz"
      sha1 "8da54323dfc9c1049bf0411db2f552593793e99f"
    end 
  end
